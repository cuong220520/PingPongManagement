package com.PingPongManagement.configs;

import com.PingPongManagement.utils.JwtRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/player-achievement-per-round/**").permitAll()
                .antMatchers("/api/team-achievement-per-round/**").permitAll()
